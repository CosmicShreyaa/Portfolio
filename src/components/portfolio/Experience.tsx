...
const EXPERIENCE_FALLBACK: ExperienceEntry[] = [
  {
    ...
    bullets: [
      ...
      "Developing Python backends and REST APIs powering real-time client communication features",
      "Sole developer on the Presales Talktime platform, owning the full stack from database to UI",
    ],
  },
  {
    kind: "education",
    company: "Delhi University",
    role: "B.Sc. Life Sciences",
    dates: "",
    bullets: [
      "Studied biological systems, research methodology, and data interpretation — skills that directly inform how I approach software architecture",
      "Developed an analytical mindset and pattern-recognition habits that transferred directly into programming and ML work",
    ],
  },
];
  ...
  return (
    <section id="experience" className="relative py-32 md:py-44">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        >
          A decade <span className="editorial-italic text-coral">in the field</span>, building
          for teams of every size<span className="text-coral">.</span>
        </motion.h2>
