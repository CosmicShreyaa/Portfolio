...
const PROJECTS_FALLBACK: ProjectContent[] = [
  {
    label: "01 / PERSONAL",
    title: "Sherlock Immersive Archive",
    description:
      "An immersive, archive-style web experience dedicated to the world of Sherlock Holmes — built for fans who read carefully and notice everything.",
    repo: "https://github.com/CosmicShreyaa/sherlock-immersive-archive",
    live: "#",
  ...
  },
  {
    ...
    description:
      "An internal presales communication and client engagement tool built for Vibgyor's interior design workflow — streamlining how the team pitches, tracks, and closes projects.",
    repo: "https://github.com/CosmicShreyaa/Vibgyor-Presales-Talktime",
    live: "#",
